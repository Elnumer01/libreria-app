...
<div class="container">
    <div class="container text-center">
        <div class="row">
            <div class="row row-cols-auto">
                <div class="col-sm-2 col-auto">
                    <button id="modalcreatebook" class="button__create " data-bs-toggle="modal" data-bs-target="#exampleModal">
                    <span>
                        <svg
                        height="24"
                        width="24"
                ...
                <div class="col-sm-6 col-auto">
                    <div class="input-container">
                        <input id="myInput" placeholder="Buscar libro..." class="input" name="text" type="text">
        ...
        @include('components.Books.ModalCreate')
